...
reserva.addEventListener('click', (e) => {
    ...
    const datos = {
        ...
        nombre: user.name,
        email: user.email,
        password: "contraseña45w996",
        telefono: "+09871654321",
        fechas: [
            {
                fecha_inicio:"2025-3-15",
                fecha_final:"2025-3-18"
            }
        ]
    };
    ...
    const data = {
        ...
        tipo: "doble",
        camas: 2,
        img: "https://v5.hotelmalibu.com.mx/uploads/habitaciones/JUNIOR%20DOBLE%20(2).webp",
        precio: 399,
        personas: 4,
        estado: "ocupada",
        ...
        descripcion: "Suite de lujo  Con más confort, con dos camas dobles y vista al mar."
...
function Pintar() {
    ...
    fetch("http://localhost:3000/habitaciones/10")
        .then(res => res.json())
        .then((datos) => {
